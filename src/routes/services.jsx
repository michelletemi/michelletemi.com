      ...
      <div className={`services-grid fade-in${visible ? ' visible' : ''}`}>
        <Link to='/newsletter' className='service-card'>
          ...
          <div className='service-desc'>
            1:1 sessions for career changers breaking into tech. CV, strategy,
            and accountability from someone who's done it.
          </div>
        ...
        <Link to='/newsletter' className='service-card'>
          ...
          <div className='service-desc'>
            Technical and behavioural interview prep. Real feedback on what
            hiring managers at fintechs actually look for.
          </div>
          <div className='service-price'>
        ...
        <Link to='/newsletter' className='service-card'>
          ...
          <div className='service-desc'>
            Practical field guides for career changers — from customer service
            to software engineer, and everything in between.
          </div>
          <div className='service-price'>
