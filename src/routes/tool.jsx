...
export default function Tool() {
  ...
  return (
    <section className='section' id='tool'>
      ...
      <div
        className={`tool-card fade-in${visible ? ' visible' : ''}`}
        ref={ref}
      >
        <div>
          ...
          <h2 className='tool-heading'>
            Know exactly where your money <em>goes.</em>
          </h2>
          <p className='tool-desc'>
            A clean, visual budget tracker built for people who want clarity
            without a spreadsheet. Add your income and categories — see your
            saving rate instantly.
          </p>
          ...
          <a href='budget-tracker.html' className='btn-tool'>
            Open the tracker →
          </a>
        </div>
        <div className='tool-preview'>
          ...
          <div className='preview-row'>
            ...
            <div className='preview-bar-bg'>
              <div
                ...
                style={{ width: '45%', background: '#c8f060' }}
              ></div>
            </div>
          ...
          <div className='preview-row'>
            ...
            <div className='preview-bar-bg'>
              <div
                className='preview-bar-fill'
                style={{ width: '18%', background: '#60b8f0' }}
              ></div>
            </div>
          ...
          <div className='preview-row'>
            ...
            <div className='preview-bar-bg'>
              <div
                className='preview-bar-fill'
                style={{ width: '10%', background: '#f0a040' }}
              ></div>
            </div>
          ...
          <div className='preview-row'>
            ...
            <div className='preview-bar-bg'>
              <div
                className='preview-bar-fill'
                style={{ width: '8%', background: '#ff7eb3' }}
              ></div>
            </div>
          ...
          <div className='preview-row'>
            ...
            <div className='preview-bar-bg'>
              <div
                className='preview-bar-fill'
                style={{ width: '7%', background: '#50d0b0' }}
              ></div>
            </div>
